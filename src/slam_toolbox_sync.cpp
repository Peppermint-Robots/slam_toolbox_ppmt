...
/*****************************************************************************/
{
  ssClear_ = this->create_service<slam_toolbox_ppmt::srv::ClearQueue>("slam_toolbox/clear_queue",
...
bool SynchronousSlamToolbox::clearQueueCallback(
  ...
  const std::shared_ptr<slam_toolbox_ppmt::srv::ClearQueue::Request> req,
  std::shared_ptr<slam_toolbox_ppmt::srv::ClearQueue::Response> resp)
/*****************************************************************************/
{

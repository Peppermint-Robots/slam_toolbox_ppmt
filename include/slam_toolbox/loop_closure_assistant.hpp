...
private:
  ...
  rclcpp::Service<slam_toolbox_ppmt::srv::Clear>::SharedPtr ssClear_manual_;
  rclcpp::Service<slam_toolbox_ppmt::srv::LoopClosure>::SharedPtr ssLoopClosure_;
  rclcpp::Service<slam_toolbox_ppmt::srv::ToggleInteractive>::SharedPtr ssInteractive_;

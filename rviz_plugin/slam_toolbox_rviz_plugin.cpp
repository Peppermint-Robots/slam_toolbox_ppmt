...
/*****************************************************************************/
{
  ...
  _serialize =
    ros_node_->create_client<slam_toolbox_ppmt::srv::SerializePoseGraph>(
    "/slam_toolbox/serialize_map");
  _load_map =
    ros_node_->create_client<slam_toolbox_ppmt::srv::DeserializePoseGraph>(
    "/slam_toolbox/deserialize_map");
  _clearChanges = ros_node_->create_client<slam_toolbox_ppmt::srv::Clear>(
    "/slam_toolbox/clear_changes");
  _saveChanges = ros_node_->create_client<slam_toolbox_ppmt::srv::LoopClosure>(
    "/slam_toolbox/manual_loop_closure");
  _saveMap = ros_node_->create_client<slam_toolbox_ppmt::srv::SaveMap>(
    "/slam_toolbox/save_map");
  _clearQueue = ros_node_->create_client<slam_toolbox_ppmt::srv::ClearQueue>(
    "/slam_toolbox/clear_queue");
  _interactive =
    ros_node_->create_client<slam_toolbox_ppmt::srv::ToggleInteractive>(
    "/slam_toolbox/toggle_interactive_mode");
  _pause_measurements = ros_node_->create_client<slam_toolbox_ppmt::srv::Pause>(
    "/slam_toolbox/pause_new_measurements");
  _load_submap_for_merging =
    ros_node_->create_client<slam_toolbox_ppmt::srv::AddSubmap>(
    "/slam_toolbox/add_submap");
  _merge = ros_node_->create_client<slam_toolbox_ppmt::srv::MergeMaps>(
...
{
  auto request =
    std::make_shared<slam_toolbox_ppmt::srv::SerializePoseGraph::Request>();
...
/*****************************************************************************/
{
  typedef slam_toolbox_ppmt::srv::DeserializePoseGraph::Request procType;
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam_toolbox_ppmt::srv::AddSubmap::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam_toolbox_ppmt::srv::MergeMaps::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam_toolbox_ppmt::srv::Clear::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam_toolbox_ppmt::srv::LoopClosure::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam_toolbox_ppmt::srv::SaveMap::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam_toolbox_ppmt::srv::ClearQueue::Request>();
...
{
  auto request =
    std::make_shared<slam_toolbox_ppmt::srv::ToggleInteractive::Request>();
...
/*****************************************************************************/
{
  auto request = std::make_shared<slam_toolbox_ppmt::srv::Pause::Request>();
